...
describe('ListFilteredRecipes', () => {
  ...
  it('should be able to list all the recipes by search name', async () => {
    const searchRecipe = 'Recipe search';
    ...
    await fakeRecipesRepository.create({
      category_id: category.id,
      name: 'Recipe 03',
      description: 'Recipe 03 description',
      steps: 'Recipe 03 steps',
      ingredients: 'Recipe 03 ingredients',
      video_url: 'Recipe 03 video URL',
    });
